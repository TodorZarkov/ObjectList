(function (global, factory) {
    ...
    function createInstance(seedData = {}) {
        ...
        function updateFile(
            ...
            for (const collectionsPair of collections) {
                const [collectionName, collectionMap] = collectionsPair;
            ...
            if (collection === 'users' || collection === 'sessions') {
                path = './protected_data';
                file = '/protectedData.json'
            }

            fs__default['default'].existsSync(path) &&
            fs__default['default'].writeFileSync(path + file, JSON.stringify(collectionsObj))
        }
    ...
    /* var protectedData = {
         users: {
             ...
             "5830061f-e16f-4fca-8267-75af083fbdd0":{
                 email: "stamat@abv.bg",
                 username: "Stamat",
                 hashedPassword: "555580b5e125b5ae1ba199eb2cf17612336cd1cc6057c245dac63d87f2d7d65e",
                 //password: "654321",
                 //_createdOn: 1680953014452,
                 //_id: "5830061f-e16f-4fca-8267-75af083fbdd0",
             }
         },
         sessions: {
         }
    ...
    var protectedData = fs__default['default'].existsSync('./protected_data') ?
        JSON.parse(fs__default['default'].readFileSync('./protected_data/' + 'protectedData.json')) :
        {};

    var seedData = fs__default['default'].existsSync('./seed_data') ?
        JSON.parse(fs__default['default'].readFileSync('./seed_data/' + 'seedData.json')) :
        {};
